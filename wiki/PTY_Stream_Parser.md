...
- **PtyStreamParser** (280 connections) — `src/ansible_aom/core/parser.py`
- **.feed_line()** (7 connections) — `src/ansible_aom/core/parser.py`
- **._handle_plaintext()** (4 connections) — `src/ansible_aom/core/parser.py`
- **.drain_warnings()** (3 connections) — `src/ansible_aom/core/parser.py`
- **._is_json()** (3 connections) — `src/ansible_aom/core/parser.py`
- **._is_jsonl_start_event()** (3 connections) — `src/ansible_aom/core/parser.py`
- **._is_jsonl_stats_event()** (3 connections) — `src/ansible_aom/core/parser.py`
- **._parse_and_return()** (3 connections) — `src/ansible_aom/core/parser.py`
...
- [[Role Group Task Models]] (54 shared connections)
...
- [[Error Handling Tests]] (11 shared connections)
- [[Parser Edge Cases]] (11 shared connections)
- [[PTY Stream Parser Tests]] (11 shared connections)
