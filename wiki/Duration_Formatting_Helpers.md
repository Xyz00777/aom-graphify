...
- **duration.py** (5 connections) — `src/ansible_aom/core/duration.py`
- **test_format_age_clamps_future_to_zero()** (3 connections) — `tests/unit/test_duration.py`
- **Render a duration keeping one decimal place under a minute ("0.4s", "12.3s").** (2 connections) — `src/ansible_aom/core/duration.py`
