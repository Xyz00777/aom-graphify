...
- **_resolve()** (5 connections) — `tests/fixtures/sessions/conftest.py`
- **test_tree_frame_signatures_are_deterministic_and_stable()** (4 connections) — `tests/integration/test_replay_determinism.py`
- **copy_session_fixture()** (4 connections) — `tests/fixtures/sessions/conftest.py`
- **session_fixtures_dir()** (4 connections) — `tests/fixtures/sessions/conftest.py`
