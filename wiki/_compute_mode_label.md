...
- **_compute_mode_label()** (18 connections) — `src/ansible_aom/compact/format.py`
...
- **.test_recording_label_is_green_when_colorized()** (2 connections) — `tests/compact/test_check_mode_chip.py`
