...
- [IncludeCacheEntry](IncludeCacheEntry.md) (34 shared connections)
- [TestGraftIncludeChildren](TestGraftIncludeChildren.md) (15 shared connections)
- [RunState](RunState.md) (12 shared connections)
- [TaskDefinition](TaskDefinition.md) (10 shared connections)
- [RoleCacheEntry](RoleCacheEntry.md) (6 shared connections)
