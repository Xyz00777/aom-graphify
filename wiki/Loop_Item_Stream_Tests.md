...
- **.test_ok_item_unchanged()** (5 connections) — `tests/compact/test_loop_item_streaming.py`
- **.test_skipped_item_colors_cyan()** (5 connections) — `tests/compact/test_loop_item_streaming.py`
- **.test_skipped_item_without_skipped_flag_renders_skipping()** (5 connections) — `tests/compact/test_loop_item_streaming.py`
- **TestDedupAgainstAggregate** (4 connections) — `tests/compact/test_loop_item_streaming.py`
- **.test_item_events_not_counted_unknown()** (4 connections) — `tests/compact/test_loop_item_streaming.py`
- **_item()** (3 connections) — `tests/compact/test_loop_item_streaming.py`
