...
- **InspectApp** (117 connections) — `src/ansible_aom/tui/screens/inspect.py`
- **test_inspect_screen.py** (51 connections) — `tests/tui/test_inspect_screen.py`
- **Path** (45 connections)
- **_settle()** (12 connections) — `tests/tui/test_inspect_screen.py`
...
- **test_detail_pane_shows_debug_var_payload()** (7 connections) — `tests/tui/test_inspect_screen.py`
- **test_run_row_renders_local_timezone()** (7 connections) — `tests/tui/test_inspect_screen.py`
...
- **test_footer_focus_text_tracks_run_play_task_and_v_flash()** (6 connections) — `tests/tui/test_inspect_screen.py`
...
- **test_detail_pane_hydrates_payload_from_disk()** (5 connections) — `tests/tui/test_inspect_screen.py`
...
- **test_loaded_sessions_are_cached()** (5 connections) — `tests/tui/test_inspect_screen.py`
- **test_loading_note_clears_on_dead_end_load()** (5 connections) — `tests/tui/test_inspect_screen.py`
- *... and 78 more nodes in this community*

## Relationships

- [TaskTreeNode](TaskTreeNode.md) (70 shared connections)
- [load_session](load_session.md) (8 shared connections)
- [StatusCounts](StatusCounts.md) (5 shared connections)
- [inspect/cli.py](inspect-cli.py.md) (2 shared connections)
- [.on_list_view_highlighted](on_list_view_highlighted.md) (2 shared connections)
